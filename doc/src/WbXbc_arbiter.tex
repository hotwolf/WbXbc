...
\subsection[WbXbc Splitter]{WbXbc Arbiter (\texttt{WbXbc\_arbiter})}
\label{arb}
    ...
    \begin{tikzpicture}
      ...
      \node [left] at (3.5,2)
            {\begin{minipage}[c]{6em}
                ...
                \end{flushright}
             \end{minipage}};
      \draw [ultra thick, ->] (3.5,2.75) -- (4.5,2.75);
      \draw [ultra thick, ->] (3.5,2.25) -- (4.5,2.25);
      \node [rotate=90] at (3.75,1.75) {\small{\texttt{...}}};
      \draw [ultra thick, ->] (3.5,1.25) -- (4.5,1.25);
     %Outputs     
      \node [right] at (8.5,2)
