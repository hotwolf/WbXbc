...
\begin{figure}[!h]
  \begin{center}
    \begin{tikzpicture}
      ...
      \node [left] at (3.5,2)
            {\begin{minipage}[c]{6em}
                \begin{flushright}
                  \hyphenchar\font=-1
                  \small{Initiator Bus w/out Selects}
                \end{flushright}
             \end{minipage}};
    ...
    \end{tikzpicture}
    \caption[Block Diagram]{Block Diagram of the \nameref*{adec}}
    \label{adec:diag}
  \end{center}
\end{figure}
...
\begin{center}
  ...
  \begin{longtable}{|l|r|l|}
    \rowcolor{white}
    \caption[Integration Parameters]{Integration Parameters of the \nameref*{adec}}
...
\begin{center}
  ...
  \begin{longtable}{|l|r|l|l|}
    \rowcolor{white}
    \caption[Interface Signals]{Interface Signals of the \nameref*{adec}}
    \label{adec:sig:tab} \\
    %Header
    \hline                                     
    \rowcolor{gray!25}
    ...
    \hline                                    
    \texttt{region\_addr}   & \texttt{(TGT\_CNT*ADDR\_WIDTH)\-1:0} & input & target address                             \\
    \texttt{region\_mask}   & \texttt{(TGT\_CNT*ADDR\_WIDTH)\-1:0} & input & \makecell[l]{selects relevant address bits \\
